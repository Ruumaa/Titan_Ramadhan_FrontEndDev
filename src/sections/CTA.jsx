        ...
        <div className="h-fit grid grid-cols-1 gap-y-10 md:grid-cols-2 md:gap-x-8 xl:gap-x-8 py-20">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="lg:my-auto">
              ...
              <div className="flex flex-col gap-y-4 xl:gap-y-0 xl:flex-row gap-x-2.5 mt-4 md:mx-auto lg:mx-0">
                <Button
                  // onClick={() => {}}
                  className="bg-white text-[#64748B] font-medium text-xs w-full xl:w-xs flex items-center gap-x-1.5"
                >
                ...
                <Button
                  // onClick={() => {}}
                  className="bg-secondary font-bold lg:!pr-2 lg:!pl-5 lg:text-xs md:text-sm lg:hover:text-xs hover:text-secondary hover:bg-white hover:border-secondary hover:border-2 transition duration-300 ease-in-out flex items-center gap-x-5 hover:gap-x-3  w-fit h-14 uppercase group"
                >
                  Get Started{' '}
