...
import {
  ...
  StaggerContainer,
  StaggerItem,
} from '../components/animations/AnimationWrappers.jsx';
      ...
      >
        ...
        <div className="flex size-full mx-auto text-white">
          <AnimateOnScroll
            animation="slideInUp"
            delay={0.4}
            className="w-full bg-main rounded-[4rem] mt-10 mx-5 overflow-hidden"
          >
            <StaggerContainer staggerDelay={0.2}>
              {featuresProps.slice(0, 4).map((feat, i) => (
                <StaggerItem key={i} animation="fadeInUp">
                  <FeatureContainer title={feat.title} desc={feat.desc} />
                </StaggerItem>
              ))}
